...
// ec:64:c9:ac:e0:4c (NEW)
// ec:64:c9:ac:fb:60 (OLD)
...
void closelid_little() {
  servo2.write(0);
  delay(2000);
  Serial.println("Trôi chất thải");
}

void openlid_little() {
  servo2.write(90);
  delay(2000);
  Serial.println("Mở nắp chặn phân");
}
...
void clear() {
  ...
  void Capture() {
    if (checkCam == 1) {
      ...
      wifiConnect();
      delay(2000);
      Serial.println("Chụp hình");
    }
    else {
      Serial.println("Không chụp ảnh");
    }
  }
