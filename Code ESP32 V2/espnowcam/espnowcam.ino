...
String serverName = "192.168.139.215";  //--> Change with your server computer's IP address or your Domain name.
...
void setup() {
  ...
  // Adjust brightness (range: -2 to 2)
  sensor_t *sensor = esp_camera_sensor_get();
  int desired_brightness = -2; // Set your desired range (-2, -1, 0, 1, 2)
  sensor->set_brightness(sensor, desired_brightness);
